...
public class Page_01 {
    ...
    public Label Remem_me;
    public Label ŞifremiUnuttum;
    public Label Register_a_new_account;
    public Label cancel;
    public Actions pasword;
    public Label Başarısızmesajı;
    public WebElement Medunna;
    public Actions signButon;
    public Actions sign;
