...
Feature: US25 hasta hesabı olusturup randevu alma
  ...
  Scenario: US25 Negatif test hatali telefon numarasi
    ...
    And     K4 Hasta hesabıyla giris yapar
    And     K4 Hasta hesabıyla myPages butonuna tiklar
    And     K4 MyAppointments butonuna tiklar
    And     K4 Gecersiz bir telefon numarasi girer
    And     K4 Randevu icin tarih secer
    And     K4 Randevu tamamlamak icin SendAppointment tusuna basar
